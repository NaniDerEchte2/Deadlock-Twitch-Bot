...
BILLING_PLANS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "name": "Raid Boost",
        "badge": "raids",
        "description": "Priorisierte Einbeziehung in Raids \u2014 mehr Sichtbarkeit f\u00fcr deinen Kanal.",
        "monthly_net_cents": 799,
        "recommended": False,
        "features": [
            "Priorisierte Raid-Empfehlung im Netzwerk",
            "Geeignet für aktive Growth-Phasen",
            "Raids selbst bleiben weiterhin zusaetzlich nutzbar",
        ],
    },
    {
        ...
        "badge": "analytics",
        "description": "Verstehe dein Wachstum mit detaillierten Statistiken und Session-Insights.",
        "monthly_net_cents": 1699,
        "recommended": True,
        "features": [
            "Erweiterte Session- und Growth-Insights",
            "Vergleich von Zeitraeumen und Streams",
            "Retention- und Performance-Übersichten",
        ],
    },
    {
        ...
        "badge": "bundle",
        "description": "Kombiniert Analyse Dashboard und Raid Boost in einem gemeinsamen Abo.",
        "monthly_net_cents": 2299,
        "recommended": False,
        "features": [
            "Alle Analyse Dashboard Features",
            "Raid Boost mit bevorzugten Raids",
            "Beide Module in einem Paket gebuendelt",
        ],
    },
)
